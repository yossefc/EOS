...
start "EOS Backend - Flask" cmd /k "cd /d D:\EOS\backend && call venv\Scripts\activate.bat && set DATABASE_URL=postgresql+psycopg2://postgres:postgres@localhost:5432/eos_db && python app.py"
