...
class Donnee(db.Model):
    ...
    # Champs pour la date et lieu de naissance mis à jour par l'enquêteur (PARTNER)
    dateNaissance_maj = db.Column(db.Date)
    lieuNaissance_maj = db.Column(db.String(50))
    adresse1 = db.Column(db.String(255))
    adresse2 = db.Column(db.String(255))
    adresse3 = db.Column(db.String(255))
    adresse4 = db.Column(db.String(255))
